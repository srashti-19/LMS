    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          <div className='flex items-center gap-3 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] border border-blue-500 p-4 w-58 rounded-md'>
        ...
        <div>
          ...
          <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20'>
            <table className='table-fixed md:table-auto w-full border-b border-gray-500/20 text-sm text-left'>
              <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left'>
                <tr>
                  <th className='px-4 py-3 dont-semibold text-center hidden sm:table-cell'>#</th>
